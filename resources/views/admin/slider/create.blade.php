             ...
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-slide')}}" method="post"> {{csrf_field()}}
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" placeholder="Enter Part One" name="part_1" id="part_1" required>
                      </div>
                      <div class="form-group">
                        <label>Slide Part Two</label>
                        <input type="text" class="form-control" placeholder="Enter Part Two" name="part_2" id="part_2" required>
                     </div>
                     <div class="form-group">
                        <label>Slide Part Three</label>
                        <input type="text" class="form-control" placeholder="Enter Part Three" name="part_3" id="part_3" required>
                     </div>
                      <div class="form-group">
