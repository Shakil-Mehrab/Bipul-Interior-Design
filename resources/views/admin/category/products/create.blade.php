             ...
             <div class="panel panel-bd lobidrag">
                <div class="panel-heading">
                   <div class="btn-group" id="buttonlist">
                      <a class="btn btn-add " href="{{url('admin/view-product/bycategory',$category->id)}}">
                      <i class="fa fa-eye"></i>  View Designs </a>
                   </div>
                </div>
                <div class="panel-body">
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-product/bycategory',$category->id)}}" method="post"> {{csrf_field()}}
