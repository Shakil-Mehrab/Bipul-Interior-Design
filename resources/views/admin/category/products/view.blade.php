             ...
             <div class="panel panel-bd lobidrag">
                ...
                <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                   <div class="btn-group">
                      ...
                      <a class="btn btn-add" href="{{url('/admin/add-product/bycategory',$category->id)}}"> <i class="fa fa-plus"></i> Add Design
                         </a>
                      </div>
                   ...
                   <div class="table-responsive">
                      <table id="table_id" class="table table-bordered table-striped table-hover">
                         ...
                         <tbody>
                            @foreach($category->allCatProducts as $product)
                            <tr>
                                <td>{{$product->id}}</td>
                                <td>{{$product->name}}</td>
